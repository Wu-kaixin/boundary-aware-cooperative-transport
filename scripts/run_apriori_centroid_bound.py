...
from dbact.static_deployment_diagnostics import (  # noqa: E402
    DISSIPATION_TOL_ABS,
    DISSIPATION_TOL_REL,
    OBSERVER_SLACK_DUMP,
...
from dbact.static_deployment_diagnostics import UniformOffsetObserver  # noqa: E402
...
def main() -> None:
    ...
    src_der = ROOT / "theory" / "static_deployment" / "main_theorem.md"
    if src_der.exists():

...
from dbact_sim.visualization.animation import ensure_mp4_export_available, render_animation

animation_module = importlib.import_module("dbact_sim.visualization.animation")
...
def test_publication_encoder_check_runs_before_rendering(monkeypatch):
    called = []
    monkeypatch.setattr(
        animation_module,
